package com.sen.aiagentsen.chatMemory;
...
public class DatabaseChatMemory implements ChatMemory {
    ...
    private final TcmReportMapper loveReportMapper;
     ...
     */
    public DatabaseChatMemory(TcmReportMapper loveReportMapper) {
    ...
    public void clear(String conversationId) {
        try {
            // 构建查询条件
            LambdaQueryWrapper<TcmReport> queryWrapper = new LambdaQueryWrapper<>();
            queryWrapper.eq(TcmReport::getChatId, getSafeConversationId(conversationId));
    ...
    private List<Message> getOrCreateConversation(String conversationId) {
        ...
        try {
            // 构建查询条件
            LambdaQueryWrapper<TcmReport> queryWrapper = new LambdaQueryWrapper<>();
            queryWrapper.eq(TcmReport::getChatId, safeConversationId);

            // 查询数据库
            TcmReport loveReport = loveReportMapper.selectOne(queryWrapper);
    ...
    private void saveConversation(String conversationId, List<Message> messages) {
        ...
        try {
            ...
            // 查询数据库中是否已存在该对话的记录
            TcmReport existingReport = loveReportMapper.selectOne(queryWrapper);
            ...
            if (existingReport != null) {
                ...
                // 创建新记录
                TcmReport newReport = TcmReport.builder()
